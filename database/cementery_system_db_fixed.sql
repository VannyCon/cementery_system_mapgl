...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2025 at 03:49 AM (Updated)
...
(1, 'Cementery 1', 'Main cemetery location', '10.8874592', '123.4215742', 'uploads/Oasis_1757924149_df8f349e.png', '2025-09-15 08:15:49');
...
(3, 'Rosa Mendoza', '1970-12-25', '2021-05-05', '2021-05-10', 'C-303', 1, 'Carlos Mendoza', '09283456712', 'Loving sister and aunt.', '2025-09-20 01:14:53', '2025-09-20 01:14:53'),
(4, 'Jose Ramirez', '1939-03-03', '2020-01-20', '2020-01-25', 'D-404', 1, 'Maria Ramirez', '09182345678', 'Cherished grandfather.', '2025-09-20 01:14:53', '2025-09-20 01:14:53'),
(5, 'Elena Villanueva', '1985-09-30', '2024-07-02', '2024-07-06', 'E-505', 1, 'Luis Villanueva', '09391239876', 'Always remembered for her kindness.', '2025-09-20 01:14:53', '2025-09-20 01:14:53');
...
--
-- Table structure for table `tbl_layer_annotations`
--

CREATE TABLE `tbl_layer_annotations` (
  `id` int(10) UNSIGNED NOT NULL,
  `cemetery_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `tbl_layer_annotations`
--

INSERT INTO `tbl_layer_annotations` (`id`, `cemetery_id`, `geometry`, `label`, `color`, `notes`, `created_at`, `updated_at`) VALUES
(1, 1, 0x00000000010300000001000000050000007008556af6da5e4083c0caa145c6254094de37bef6da5e4083c0caa145c6254094de37bef6da5e409f71e14048c625407008556af6da5e409f71e14048c625407008556af6da5e4083c0caa145c62540, 'layer 1', '#00FF00', 'Boundary for grave A-106.', '2025-09-20 01:48:15', '2025-09-20 01:48:15');
...
ALTER TABLE `tbl_burial_records`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_burial_cemetery` (`cemetery_id`);
...
--
-- Indexes for table `tbl_layer_annotations`
--
ALTER TABLE `tbl_layer_annotations`
  ADD PRIMARY KEY (`id`),
  ADD SPATIAL KEY `geometry` (`geometry`),
  ADD KEY `fk_annotations_cemetery` (`cemetery_id`);
...
--
-- AUTO_INCREMENT for table `tbl_layer_annotations`
--
ALTER TABLE `tbl_layer_annotations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_roads`
  ADD CONSTRAINT `fk_roads_cemetery` FOREIGN KEY (`cemetery_id`) REFERENCES `tbl_place_cemeteries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_burial_records`
--
ALTER TABLE `tbl_burial_records`
  ADD CONSTRAINT `fk_burial_cemetery` FOREIGN KEY (`cemetery_id`) REFERENCES `tbl_place_cemeteries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_grave_plots`
--
ALTER TABLE `tbl_grave_plots`
  ADD CONSTRAINT `fk_graveplots_cemetery` FOREIGN KEY (`cemetery_id`) REFERENCES `tbl_place_cemeteries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_layer_annotations`
--
ALTER TABLE `tbl_layer_annotations`
  ADD CONSTRAINT `fk_annotations_cemetery` FOREIGN KEY (`cemetery_id`) REFERENCES `tbl_place_cemeteries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
