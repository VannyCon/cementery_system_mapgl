    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mobileNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" id="mobileHomeLink">
                ...
                <div id="mobileAdminNav" style="display: none;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../admin/plots/">
                            <i class="fas fa-square me-1"></i>Grave Plots
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../admin/roads/">
                            <i class="fas fa-road me-1"></i>Roads
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text" id="mobileUserRole">Loading...</span></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-user me-2"></i>Profile</a></li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-cog me-2"></i>Settings</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="#" onclick="handleMobileLogout()">
