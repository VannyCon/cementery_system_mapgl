...
<!-- Grave Plot Modal -->
<div class="modal fade" id="graveModal" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <form id="gravePlotForm">
                <div class="modal-body">
                    ...
                    <input type="hidden" id="gravePlotCoordinates" name="coordinates">
                    ...
                    <div class="mb-3">
                        <label for="graveLocation" class="form-label">Location</label>
                        <input type="text" class="form-control" id="graveLocation" name="location">
                    </div>
                    <div class="mb-3">
